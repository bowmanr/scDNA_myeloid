...
DTAI_genes <- c("FLT3","NRAS","KRAS","PTPN11","JAK2")
...
tiff(width=5,height=5,res=300, units = "in",file="/Volumes/LevineLab/Levine Lab/Bobby/Collaborations/MissionBio/Analysis/2020/January/Figures/F2F-network_signaling.tiff") # or other device
