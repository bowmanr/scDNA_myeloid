...
Our streps for post processing are below:
...
```{r reread SNV files, message=FALSE}
...
```{r create protein annotations, message=FALSE,warning=FALSE,cache=TRUE}
...
```{r annotate NGT column names to protein IDs filter hits,cache=TRUE}
